...
export default function CreativeResume() {
  ...
  const [editableResume, setEditableResume] = useState({
    ...
    summary: "Creative professional with experience in design, media, and advertising.",
    contact: [
      { type: "email", value: "your.email@example.com" },
      { type: "phone", value: "+1 (555) 123-4567" },
      { type: "location", value: "New York, NY" },
      { type: "website", value: "yourportfolio.com" }
    ],
    education: [
      {
        ...
        duration: "2018 - 2022",
        description: "Specialized in Graphic Design with minor in Digital Marketing"
      }
    ],
    experiences: [
      {
        ...
        description: "Lead design projects for major clients, manage junior designers, and develop brand identity systems."
      },
      {
        title: "Graphic Designer",
        company: "Media Solutions",
        duration: "Mar 2020 - Dec 2021",
        description: "Created visual assets for digital and print campaigns, collaborated with marketing teams on brand strategy."
      }
    ],
    skills: [
    ...
    projects: [
      {
        ...
        client: "Tech Startup",
        duration: "2023",
        description: "Complete rebrand including logo design, visual identity system, and marketing materials."
      },
      {
        title: "Interactive Annual Report",
        client: "Financial Services Company",
        duration: "2022",
        description: "Designed and developed an interactive digital annual report with data visualizations."
      }
    ],
    awards: [
      {
        title: "Design Excellence Award",
        issuer: "Creative Industry Association",
        date: "2023"
      },
      {
        title: "Rising Talent Recognition",
        issuer: "Design Week Magazine",
        date: "2021"
      }
    ],
    languages: [
    ...
    <div className="flex flex-row gap-6 w-full bg-gray-100 p-4 h-screen">
      ...
      <div className="w-1/2 bg-white shadow-md rounded-xl p-6 overflow-y-auto">
        ...
        {currentSection === "language" && !isEditing && (
                ...
                {currentSection === "color" && (
                  <div>
                    ...
                    <div className="grid grid-cols-5 gap-3">
                      {['#4f46e5', '#10b981', '#3b82f6', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899', '#14b8a6', '#84cc16', '#f97316'].map((color) => (
                        <button
                          key={color}
                          onClick={() => handleColorChange(color)}
                          className={`w-10 h-10 rounded-full ${editableResume.accentColor === color ? 'ring-2 ring-offset-2 ring-gray-400' : ''}`}
                  ...
                  <div className="space-y-4 mt-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => handleDraftChange("duration", e.target.value)}
                        className="w-full p-2 border rounded-md"
                        placeholder="e.g. 2022 or Jan - Mar 2023"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Description</label>
                  ...
                  <div className="space-y-4 mt-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-2 border rounded-md"
                        placeholder="e.g. 2023 or May 2022"
                      />
                    </div>
                    <div className="flex justify-end gap-2">
                      <button
              ...
              <div className="w-1/2 bg-white shadow-lg rounded-xl overflow-hidden overflow-y-auto">
                <div className="p-8" ref={resumeRef}>
                  {/* Header with name and title */}
                  <div className="flex justify-between items-start mb-8">
                    <div>
                      <h1 className="text-3xl font-bold" style={{color: editableResume.accentColor}}>
                        {editableResume.name}
                      </h1>
                    ...
                    {editableResume.photo && (
                      <img 
                        ...
                        style={{borderColor: editableResume.accentColor}}
                      />
                    )}
                  </div>
                  ...
                  {/* Summary */}
                  <div className="mb-8">
                    <h3 className="text-lg font-semibold mb-2 pb-1 border-b" style={{borderColor: editableResume.accentColor}}>
                      Summary
                    </h3>
                  ...
                  {editableResume.education.length > 0 && (
                    <div className="mb-8">
                      <h3 className="text-lg font-semibold mb-4 pb-1 border-b" style={{borderColor: editableResume.accentColor}}>
                        Education
                      </h3>
                      <div className="space-y-4">
                        {editableResume.education.map((edu, index) => (
                          <div key={index} className="pl-4 border-l-2" style={{borderColor: editableResume.accentColor}}>
                            <h4 className="font-semibold">{edu.degree}</h4>
                  ...
                  {editableResume.languages.length > 0 && (
                    <div className="mb-8">
                      ...
                      <div className="flex flex-wrap gap-4">
                        {editableResume.languages.map((language, index) => (
                          <div key={index} className="px-3 py-1 rounded-full bg-gray-100">
                            <span className="font-medium">{language.name}</span>
                            <span className="text-sm text-gray-600 ml-2">({language.proficiency})</span>
                          </div>
                        ))}
                      </div>
                    </div>
